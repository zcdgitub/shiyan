...
class AuthItemController extends Controller
{
	...
	*/
	public function actionPermissions()
	{
		...
		$dataProvider = new RPermissionDataProvider('permissions',['pagination'=>$pagination]);
	...
	public function actionCreate()
	{
		...
		if( isset($_POST['AuthItemForm'])===true )
		{
			...
			if( $formModel->validate()===true )
			{
				...
				$this->_authorizer->authManager->addItemChild($item->name,'authenticated');
	...
	public function actionUpdate($page=1)
	{
		...
		if( isset($_POST['AuthItemForm'])===true )
		{
			...
			if( $formModel->validate()===true )
			{
				...
				// Redirect to the correct destination
				$this->redirect(array('authItem/permissions','page'=>$page));
			}
		}
