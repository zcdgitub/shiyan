...
* ),
*/
class PrivilegeModule extends CWebModule
{
	/**
	...
	*/
	public function init()
	{
		...
		$this->setImport(array(
			...
			'privilege.components.behaviors.*',
			'privilege.components.dataproviders.*',
	...
	*/
	public function registerScripts()
	{
		...
		$cs->registerScriptFile($assetsUrl.'/js/rights.js',CClientScript::POS_HEAD);
	...
	*/
	public function getAssetsUrl()
	{
		...
		{
			$assetsPath = Yii::getPathOfAlias('privilege.assets');
