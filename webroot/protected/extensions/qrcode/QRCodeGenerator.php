...
class QRCodeGenerator extends CWidget {
    ...
    public function init()
    {
        ...
        if (!$this->filePath){
            $this->filePath = realpath(params('upload_tmp'));
        }
        ...
        if (!isset($this->fileUrl)){
            $this->fileUrl = '/'. Yii::app()->getBaseUrl() .path2url(params('upload_tmp'));
        }
		...
		$this->filePath = $this->filePath . DIRECTORY_SEPARATOR . $this->filename;
