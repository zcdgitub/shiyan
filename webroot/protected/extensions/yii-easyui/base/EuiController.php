...
class EuiController extends Controller
{
     ...
     */
    public function exportToJSONData($data, $total=null)
    {
		if(is_null($data) || $data===[])
		{
			return CJSON::encode(array('total'=>0,'rows'=>[]));
		}
    	$exports = array(); 		
	...
	public function exportToJSONSuccess($status)
	{
		return CJSON::encode(['success'=>$status]);
	}
