...
class zTree extends CJuiWidget
{
	...
	{
		$this->scriptFile=array(YII_DEBUG?'jquery.ztree.all-3.5.js':'jquery.ztree.all-3.5.min.js');
	...
	protected function getRegisterScripts()
	{
		...
		$js[] = "zTree_{$this->id} = $.fn.zTree.init($('#{$this->id}'), {$options}, {$this->data});";
		return $js;
	}
