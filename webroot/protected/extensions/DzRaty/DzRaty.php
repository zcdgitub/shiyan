...
class DzRaty extends CInputWidget
{
	...
	public function init()
	{
		...
		$this->_defaultOptions = array(
			...
			'hints' => array(
				Yii::t('DzRaty.DzRaty','很差'),
				Yii::t('DzRaty.DzRaty','差'),
				Yii::t('DzRaty.DzRaty','一般'),
				Yii::t('DzRaty.DzRaty','好'),
				Yii::t('DzRaty.DzRaty','很好')
			),
			'noRatedMsg' => Yii::t('DzRaty.DzRaty','没有评分'),
			'cancelHint' => Yii::t('DzRaty.DzRaty', '取消评分'),
		);
	}
	...
	protected function registerClientScript()
	{
		...
		$cs->registerScriptFile("{$this->assetsUrl}/js/jquery.raty" . (YII_DEBUG ? '' : '.min') . ".js",CClientScript::POS_HEAD);
