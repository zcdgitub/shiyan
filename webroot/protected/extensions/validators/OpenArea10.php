 ...
 * @since 1.0
 */
class OpenArea10 extends CValidator
{
	...
	protected function validateAttribute($object,$attribute)
	{
		...
		if($value>$member->membermap_level+2)
		{
			$ml=MemberLevel::model()->findByPk($value-2);
			$message=t('epmms',chr(64+$value) . '区未开通,' .  '升级到' . $ml->showName . '才能开通');
			$this->addError($object,$attribute,$message);
		}
	}
}
