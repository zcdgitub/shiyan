 ...
 */
class VerifyCode extends CValidator
{
	/**
	...
	protected function validateAttribute($object,$attribute)
	{
		...
		if(time()-$_SESSION['verify_timestamp']<300)
		{
			if($value==$_SESSION['verify_code'])
			{
				return;
			}
			$this->addError($object,$attribute,'验证码错误');
			return;
		}
		$this->addError($object,$attribute,'验证码过期');
	}
