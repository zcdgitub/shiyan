 ...
 * @since 1.0
 */
class AbleTransferDstRole extends CValidator
{
	...
	protected function validateAttribute($object,$attribute)
	{
		...
		$myrole='';
		switch($member->memberinfo_is_agent)
		{
			case 0:
				$myrole='member';
				break;
		...
		if(array_search($myrole,$config->transfer_config_dst_role)===false)
		{
			$this->addError($object,$attribute,$member->memberinfo_account . t('epmms','不能转账'));
			return;
		}
	}
}
