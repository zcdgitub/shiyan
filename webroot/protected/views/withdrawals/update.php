...
$this->breadcrumbs=array(
	...
	$model->showName=>array('view','id'=>$model->withdrawals_id),
	t('epmms','修改'),
);
...
$this->menu=array(
	...
	array('label'=>t('epmms','查看') . t('epmms',$model->modelName), 'url'=>array('view', 'id'=>$model->withdrawals_id)),
	array('label'=>t('epmms','管理') . t('epmms',$model->modelName), 'url'=>array('index')),
);
?>

<h1><?php echo t('epmms','修改') . t('epmms',$model->modelName); ?></h1>
