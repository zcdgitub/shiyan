...
<table class="form">
	...
	<tr class="row">
		<td class="title">
			<?php echo $form->labelEx($model,'sale_money'); ?>
		</td>
		<td class="value">
		...
		<td class="hint"></td>
		<td class="error">
			<?php echo $form->error($model,'sale_money',array(),false); ?>
		</td>
	</tr>

	<tr class="row">
		<td class="title">
			<?php echo $form->labelEx($model,'sale_remain_currency'); ?>
		</td>
		<td class="value">
		...
		<td class="hint"></td>
		<td class="error">
			<?php echo $form->error($model,'sale_remain_currency',array(),false); ?>
		</td>
	</tr>
	...
	<tr class="row">
		...
		<td class="hint"></td>
		<td class="error">
			<?php echo $form->error($model,'sale_status',array(),false); ?>
		</td>
	</tr>

	<tr class="row">
		<td class="title">
			<?php echo $form->labelEx($model,'sale_verify_date'); ?>
		</td>
		<td class="value">
		...
		<td class="hint"></td>
		<td class="error">
			<?php echo $form->error($model,'sale_verify_date',array(),false); ?>
		</td>
	</tr>
