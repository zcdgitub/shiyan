...
?>
	...
	<table class="form">
		<tr class="row">
			<td class="title">
				<?php echo $form->labelEx($model,'signing_date'); ?>
			</td>
			<td class="value">
				<?php echo $form->hiddenField($model,'signing_member_id'); ?>
				<?php echo $form->date($model,'signing_date',array('size'=>20,'maxlength'=>0)); ?>
			</td>
			<td class="hint"></td>
			<td class="error">
				<?php echo $form->error($model,'signing_date',array(),false); ?>
			</td>
		</tr>
	</table>
