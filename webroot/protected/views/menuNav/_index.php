...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('menu-nav-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php
$this->widget('ext.Flashes.Dialog',array('keys'=>array('error'),'target'=>'#menu-nav-grid'));
$columns=array(
array('class'=>'DataColumn','value'=>'$row+1','header'=>t('epmms','序号'),'htmlOptions' => array('style'=>'width:40px')),
	'menu_name',
	'menu_url',
	['name'=>'menuP.menu_name','filter'=>MenuNav::model()->getListData('menu_pid is null'),'header'=>$model->getAttributeLabel('menu_pid')],
	'menu_order',
	array(
	'class'=>'ButtonColumn',
	'template'=>'{view}',
