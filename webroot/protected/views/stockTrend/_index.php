...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('stock-trend-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php
$this->widget('ext.Flashes.Dialog',array('keys'=>array('error'),'target'=>'#stock-trend-grid'));
$columns=array(
array('class'=>'DataColumn','value'=>'$row+1','header'=>t('epmms','序号'),'htmlOptions' => array('style'=>'width:40px')),
	'stock_trend_value',
	'stock_trend_date',
	array('class'=>'RelationDataColumn','name'=>'stockTrendMemberinfo.memberinfo_account'),
	array(
	'class'=>'ButtonColumn',
	'template'=>'{view}',
	),
