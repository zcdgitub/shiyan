...
$columns2=array(
	...
	'bank'=>array('class'=>'DataColumn','name'=>'awardDaySumMemberinfo.memberinfoBank.bank_name'
	,'headerHtmlOptions'=>['style'=>'width:100px;']),
	array('class'=>'DataColumn','name'=>'awardDaySumMemberinfo.memberinfo_bank_name'),
	'bank_account'=>array('class'=>'DataColumn','name'=>'awardDaySumMemberinfo.memberinfo_bank_account'),
	'withdrawals'=>array(
		'class'=>'CLinkColumn',
		'urlExpression'=>'$this->grid->controller->createUrl("awardDaySum/payoff",["member_id"=>$data->award_day_sum_memberinfo_id])',
		'label'=>t('epmms','提现')
	,'headerHtmlOptions' => array('style'=>'width:40px')
	),
	'salary_del'=>array(
		'class'=>'CLinkColumn',
		'urlExpression'=>'$this->grid->controller->createUrl("awardDaySum/salaryDel",["id"=>$data->award_day_sum_id])',
		'label'=>t('epmms','删除')
	,'headerHtmlOptions' => array('style'=>'width:40px'),
	),
);
