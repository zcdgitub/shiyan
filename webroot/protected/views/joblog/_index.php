...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('joblog-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php
$this->widget('ext.Flashes.Dialog',array('keys'=>array('error'),'target'=>'#joblog-grid'));
$columns=array(
array('class'=>'DataColumn','value'=>'$row+1','header'=>t('epmms','序号'),'htmlOptions' => array('style'=>'width:40px')),
	'job.jobname',
	['name'=>'jlgstatus','type'=>'jobstatus','filter'=>['r'=>'正在运行','s'=>'成功','f'=>'失败','i'=>'无法执行','d'=>'执行中断']],
	'jlgstart',
	'jlgduration',
);
switch($selTab)
