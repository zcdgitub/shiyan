...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('award-year-sum-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
$columns1=array(
	...
	array('class'=>'RelationDataColumn','name'=>'awardYearSumMemberinfo.memberinfo_account','headerHtmlOptions'=>['style'=>'width:100px;']));
$columns2=array(
	['name'=>'award_year_sum_currency','headerHtmlOptions'=>['style'=>'width:100px;'],'type'=>'money'],
	['name'=>'award_year_sum_date','headerHtmlOptions'=>['style'=>'width:120px;']],
);
$columns=array_merge($columns1,$gridColumn,$columns2);
$this->widget('ext.Flashes.Dialog',array('keys'=>array('error'),'target'=>'#award-year-sum-grid'));
$this->widget('EExcelView', array(
	'id'=>'award-year-sum-grid',
	'ajaxUpdate'=>false,
