...
<table class="form">
	<tr class="row">
		<td class="title">
			<?php echo $form->labelEx($model,'prize_info'); ?>
		</td>
		<td class="value">
		...
		<td class="hint"></td>
		<td class="error">
			<?php echo $form->error($model,'prize_info',array(),false); ?>
		</td>
	</tr>

	<tr class="row">
		<td class="title">
			<?php echo $form->labelEx($model,'prize_is_verify'); ?>
		</td>
		<td class="value">
		...
		<td class="hint"></td>
		<td class="error">
			<?php echo $form->error($model,'prize_is_verify',array(),false); ?>
		</td>
	</tr>

	<tr class="row">
		<td class="title">
			<?php echo $form->labelEx($model,'prize_verify_date'); ?>
		</td>
		<td class="value">
		...
		<td class="hint"></td>
		<td class="error">
			<?php echo $form->error($model,'prize_verify_date',array(),false); ?>
		</td>
	</tr>

	<tr class="row">
		<td class="title">
			<?php echo $form->labelEx($model,'prize_date'); ?>
		</td>
		<td class="value">
		...
		<td class="hint"></td>
		<td class="error">
			<?php echo $form->error($model,'prize_date',array(),false); ?>
		</td>
	</tr>

	<tr class="row">
		<td class="title">
			<?php echo $form->labelEx($model,'prize_member_id'); ?>
		</td>
		<td class="value">
		...
		<td class="hint"></td>
		<td class="error">
			<?php echo $form->error($model,'prize_member_id',array(),true); ?>
		</td>
	</tr>
