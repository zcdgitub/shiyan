...
$columns=array(
	...
	array('name'=>'memberinfo_init_password','visible'=>$item->getAdminItem('memberinfo_init_password')),
	array('name'=>'memberinfo_init_password2','visible'=>$item->getAdminItem('memberinfo_init_password2')),
