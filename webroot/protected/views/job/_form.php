...
<table class="form">
	...
	<tr class="row">
		...
		<td class="value">
			<?php echo $form->textField($model,'jobname'); ?>
		</td>
		<td class="hint"></td>
		<td class="error">
			<?php echo $form->error($model,'jobname',array(),false); ?>
		</td>
	</tr>
	...
	<tr class="row">
		...
		<td class="hint"></td>
		<td class="error">
			<?php echo $form->error($model,'jobdesc',array(),false); ?>
		</td>
	</tr>

	<tr class="row">
		<td class="title">
			<?php echo $form->labelEx($model,'jobenabled'); ?>
		</td>
		<td class="value">
		...
		<td class="hint"></td>
		<td class="error">
			<?php echo $form->error($model,'jobenabled',array(),false); ?>
		</td>
	</tr>
