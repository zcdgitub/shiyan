...
$columns1=array(
	...
	array('class'=>'DataColumn','name'=>'awardMonthSumMemberinfo.memberinfo_nickname','headerHtmlOptions'=>['style'=>'width:100px;']),
	array('class'=>'DataColumn','name'=>'awardMonthSumMemberinfo.memberinfo_account','headerHtmlOptions'=>['style'=>'width:100px;']));
$columns2=array(
	['name'=>'award_month_sum_currency','headerHtmlOptions'=>['style'=>'width:100px;'],'type'=>'money'],
	...
	['name'=>'award_month_sum_date','headerHtmlOptions'=>['style'=>'width:120px;']],
	'bank'=>array('class'=>'DataColumn','name'=>'awardMonthSumMemberinfo.memberinfoBank.bank_name'
	,'headerHtmlOptions'=>['style'=>'width:100px;']),
	array('class'=>'DataColumn','name'=>'awardMonthSumMemberinfo.memberinfo_bank_name'),
	'bank_account'=>array('class'=>'DataColumn','name'=>'awardMonthSumMemberinfo.memberinfo_bank_account'),
	'withdrawals'=>array(
		'class'=>'CLinkColumn',
		'urlExpression'=>'$this->grid->controller->createUrl("awardMonthSum/payoff",["member_id"=>$data->award_month_sum_memberinfo_id])',
		'label'=>t('epmms','提现')
	,'headerHtmlOptions' => array('style'=>'width:40px')
	),
	'salary_del'=>array(
		'class'=>'CLinkColumn',
		'urlExpression'=>'$this->grid->controller->createUrl("awardMonthSum/salaryDel",["id"=>$data->award_month_sum_id])',
		'label'=>t('epmms','删除')
	,'headerHtmlOptions' => array('style'=>'width:40px'),
	),
);
