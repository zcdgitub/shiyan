...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('award-month-sum-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
$columns1=array(
	...
	array('class'=>'RelationDataColumn','name'=>'awardMonthSumMemberinfo.memberinfo_account','headerHtmlOptions'=>['style'=>'width:100px;']));
$columns2=array(
...
$this->widget('ext.Flashes.Dialog',array('keys'=>array('error'),'target'=>'#award-month-sum-grid'));
$this->widget('EExcelView', array(
	'id'=>'award-month-sum-grid',
	'ajaxUpdate'=>false,
