...
$this->menu=array(
	...
	array('label'=>t('epmms','我要') . t('epmms',$model->modelName), 'url'=>array('create')),
);
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('supplement-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php
$this->widget('ext.Flashes.Dialog',array('keys'=>array('error'),'target'=>'#supplement-grid'));
$columns=array(
array('class'=>'DataColumn','value'=>'$row+1','header'=>t('epmms','序号'),'htmlOptions' => array('style'=>'width:40px')),
	'supplement_currency',
	array('class'=>'RelationDataColumn','name'=>'supplementMember.memberinfo_account'),
	'supplement_member_level',
	'supplement_date',
	array(
	'class'=>'ButtonColumn',
	'template'=>'{view}',
